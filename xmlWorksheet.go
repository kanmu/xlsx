...
func newXlsxWorksheet() (worksheet *xlsxWorksheet) {
	...
	worksheet.PageMargins.Left = 0
	worksheet.PageMargins.Right = 0
	worksheet.PageMargins.Top = 0
	worksheet.PageMargins.Bottom = 0
	worksheet.PageMargins.Header = 0
	worksheet.PageMargins.Footer = 0
